...
export declare namespace ImageListPageFiguresResponse {
    interface ImageListPageFiguresResponseItem {
        /**
...
export declare namespace ImageListPageScreenshotsResponse {
    interface ImageListPageScreenshotsResponseItem {
        /**
