...
const data_sinks_1 = require("./resources/data-sinks.js");
const data_sources_1 = require("./resources/data-sources.js");
const files_1 = require("./resources/files.js");
const parsing_1 = require("./resources/parsing.js");
const projects_1 = require("./resources/projects.js");
const beta_1 = require("./resources/beta/beta.js");
const classifier_1 = require("./resources/classifier/classifier.js");
const extraction_1 = require("./resources/extraction/extraction.js");
const pipelines_1 = require("./resources/pipelines/pipelines.js");
const retrievers_1 = require("./resources/retrievers/retrievers.js");
...
class LlamaCloud {
     ...
     */
    constructor({ baseURL = (0, env_1.readEnv)('LLAMA_CLOUD_BASE_URL'), apiKey = (0, env_1.readEnv)('LLAMA_CLOUD_API_KEY'), ...opts } = {}) {
        ...
        this.logLevel =
            (0, log_1.parseLogLevel)(options.logLevel, 'ClientOptions.logLevel', this) ??
                (0, log_1.parseLogLevel)((0, env_1.readEnv)('LLAMA_CLOUD_LOG'), "process.env['LLAMA_CLOUD_LOG']", this) ??
                defaultLogLevel;
        this.fetchOptions = options.fetchOptions;
        this.maxRetries = options.maxRetries ?? 2;
        this.fetch = options.fetch ?? Shims.getDefaultFetch();
        tslib_1.__classPrivateFieldSet(this, _LlamaCloud_encoder, Opts.FallbackEncoder, "f");
    ...
    buildURL(path, query, defaultBaseURL) {
        const baseURL = (!tslib_1.__classPrivateFieldGet(this, _LlamaCloud_instances, "m", _LlamaCloud_baseURLOverridden).call(this) && defaultBaseURL) || this.baseURL;
    ...
    buildBody({ options: { body, headers: rawHeaders } }) {
        ...
        ArrayBuffer.isView(body) ||
            ...
            return tslib_1.__classPrivateFieldGet(this, _LlamaCloud_encoder, "f").call(this, { body, headers });
        }
    }
}
...
LlamaCloud.Projects = projects_1.Projects;
LlamaCloud.DataSinks = data_sinks_1.DataSinks;
LlamaCloud.DataSources = data_sources_1.DataSources;
LlamaCloud.Files = files_1.Files;
LlamaCloud.Pipelines = pipelines_1.Pipelines;
LlamaCloud.Retrievers = retrievers_1.Retrievers;
LlamaCloud.Parsing = parsing_1.Parsing;
LlamaCloud.Classifier = classifier_1.Classifier;
LlamaCloud.Extraction = extraction_1.Extraction;
LlamaCloud.Beta = beta_1.Beta;
